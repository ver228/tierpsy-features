...
def obtain_food_cnt(mask_video, microns_per_pixel):
...
if __name__ == '__main__':
    ...
    for mask_video in fnames[1:]:
        ...
        food_cnt, food_r, food_centroid = obtain_food_cnt(mask_video, microns_per_pixel = read_microns_per_pixel(mask_video))

...
timeseries_feats_columns = timeseries_feats_no_dev_columns + tuple(['d_' + x for x in timeseries_feats_no_dev_columns])
...
ventral_signed_columns += tuple([x for x in velocities_columns if 'angular_velocity' in x])
ventral_signed_columns += tuple([x for x in posture_columns if 'eigen_projection' in x])
ventral_signed_columns = ventral_signed_columns + tuple(['d_' + x for x in ventral_signed_columns])

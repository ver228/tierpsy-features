...
from tierpsy_features.events import get_events, event_columns, durations_columns
...
def get_timeseries_features(skeletons, 
    ...
    return features_df, event_durations_df